...
public class TransferDetailReport {
    ...
    private static final String REQUESTGOODS_TABLE = "request_goods";
    private static final String ORDERTRANSFER_TABLE = "order_transfer";
    ...
    private static void AggregateTransfer(JavaStreamingContext jssc) {
        ...
        requestGoodsPairRDD.foreach(f ->
                System.out.println("RequstNo : " + f._1()));
